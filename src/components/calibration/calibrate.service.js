calibrateModule.factory("calibrate.service", ['progress.service', 'events.service', '$mdToast', 'settings.service', 'utility.servivce', 'cookie.service', function (progress, events, $mdToast, settings, utility, cookie) {
